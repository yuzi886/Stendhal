...
public class PotionsDealerNPC implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
	 ...
	 private void buildSigns(final StendhalRPZone zone) {
		  final ShopSign buys = new ShopSign("deniranpotionsbuy", "Wanda's Shop (buy)", "You can sell these things to potionshop.", false);
		  buys.setEntityClass("blackboard");
		  buys.setPosition(5, 6);

		  final ShopSign sells = new ShopSign("deniranpotionssell", "Wanda's Shop (sell)", "You can buy these things from potionshop.", false);
