...
public class CreatureTest {
	...
	@Test
	public void testSusceptibilityofCreature() {
		double value = 1.2;
		Creature creature = SingletonRepository.getEntityManager().getCreature("glacier centaur");
		assertThat("default susceptibility" ,creature.getSusceptibility(Nature.FIRE), closeTo(value , 0.0001));
	
		double value2 = 0.8;
		Creature creature2 = SingletonRepository.getEntityManager().getCreature("solar centaur");
		assertThat("default susceptibility" ,creature2.getSusceptibility(Nature.FIRE), closeTo(value2 , 0.0001));
		
		double value3 = 0.8;
		Creature creature3 = SingletonRepository.getEntityManager().getCreature("glacier centaur");
		assertThat("default susceptibility" ,creature3.getSusceptibility(Nature.ICE), closeTo(value3, 0.0001));
			
		double value4 =1.2;
		Creature creature4 = SingletonRepository.getEntityManager().getCreature("solar centaur");
		assertThat("default susceptibility" ,creature4.getSusceptibility(Nature.ICE), closeTo(value4, 0.0001));
	}
}
